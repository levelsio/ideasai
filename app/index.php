<?
	...
	// </set uid to track votes>
		...
		if(empty($_GET['action']) && php_sapi_name()!='cli') {
			...
			if(!$pageTitle) {
				// $pageTitle='IdeasAI: GPT-3-powered startup idea generator';
			...
			<meta name="twitter:description" content="IdeasAI is an A.I. that generates startup ideas using GPT-3 by OpenAI" />
			...
			<meta property="og:description" content="IdeasAI is an A.I. that generates startup ideas using GPT-3 by OpenAI" />
