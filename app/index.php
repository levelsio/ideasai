		...
		if(empty($_GET['action']) && php_sapi_name()!='cli') {
			...
			*/?>
			...
			<p clas="text" style="text-align:center;line-height:1.8;max-width:none;">
				<strong>
					Ideas on this page are 100% generated by <a href="https://openai.com/?ref=ideasai.net">OpenAI</a>'s GPT-3, an artifically intelligent deep learning model, without human involvement, and trained by you and <?=number_format($voteCount)?>+ other people who liked or disliked ideas. <a href="/#readme">How it works</a>
				</strong>
			</p>
