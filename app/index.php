		...
		if(empty($_GET['action']) && php_sapi_name()!='cli') {
			...
			*/?>
			...
			<p clas="text" style="text-align:center;line-height:1.8;">
				<strong>
					Ideas on this page are 100% generated by <a href="https://openai.com/?ref=ideasai.net">OpenAI</a>'s GPT-3 and the model is trained by you. <a href="/#readme">How it works</a>
				</strong>
			</p>
